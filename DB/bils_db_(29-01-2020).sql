...
INSERT INTO `menus` (`id`, `module_name`, `menu_title`, `parent_id`, `menu_url`, `serial_no`, `menu_icon_class`, `status`) VALUES
	...
	(2, 'User', 'Admin User', 1, 'admin/management', 1, NULL, 1),
	(3, 'User', 'Admin Groups', 1, 'admin/group-management', 2, NULL, 1),
	(4, 'User', 'App Users', 1, 'app-user/management', 3, NULL, 1),
	(5, 'User', 'App User Groups', 1, 'app-user/group-management', 4, NULL, 1),
	(6, 'Surveys', 'Surveys', 0, 'survey/management', 3, NULL, 1),
	(7, 'Courses', 'Courses', 0, '', 2, NULL, 1),
	(8, 'Courses', 'Open Courses', 7, 'cources/open-course', 1, NULL, 1),
	(9, 'Courses', 'Course Management', 7, 'cources/management', 2, NULL, 1),
	(10, 'Cpanel', 'Control Panel', 0, '', NULL, NULL, 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `user_type`, `user_profile_image`, `password`, `remember_token`, `login_status`, `status`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'momit@bils.com', 1, '', '$2y$10$ta1BmsLnz8H4tUqFJHI8puHxhCldn9DSwVfQjc3g59v9YSxM7.Trq', NULL, 0, 1, '2020-01-24 17:30:45', '2020-01-24 06:51:31', '2020-01-29 13:09:46');
