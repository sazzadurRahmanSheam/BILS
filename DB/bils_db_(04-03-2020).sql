...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='m';
...
INSERT INTO `notifications` (`id`, `from_id`, `from_user_type`, `to_id`, `to_user_type`, `date_time`, `notification_title`, `message`, `view_url`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Admin', 6, 'App User', '2020-03-04 13:24:02', 'BILS Initiate Labour Study Course', NULL, 'course/1', 0, '2020-03-04 07:24:02', '2020-03-04 07:24:02'),
	(2, 1, 'Admin', 7, 'App User', '2020-03-04 13:24:02', 'BILS Initiate Labour Study Course', NULL, 'course/1', 0, '2020-03-04 07:24:02', '2020-03-04 07:24:02'),
	(3, 1, 'Admin', 5, 'App User', '2020-03-04 13:24:02', 'BILS Initiate Labour Study Course', NULL, 'course/1', 0, '2020-03-04 07:24:02', '2020-03-04 07:24:02');
