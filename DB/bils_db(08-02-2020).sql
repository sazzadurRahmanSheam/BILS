...
INSERT INTO `menus` (`id`, `module_name`, `menu_title`, `menu_url`, `parent_id`, `serial_no`, `menu_icon_class`, `status`, `created_at`, `updated_at`) VALUES
	...
	(28, 'Settings', 'App User Groups', 'app-user/app-uers-group-management', 26, NULL, NULL, 1, '2020-02-07 13:30:00', '2020-02-07 13:30:00'),
...
-- Dumping data for table bils_db.users: ~2 rows (approximately)
...
INSERT INTO `users` (`id`, `name`, `nid_no`, `contact_no`, `email`, `address`, `user_type`, `user_profile_image`, `password`, `remember_token`, `login_status`, `status`, `remarks`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', '', '', 'momit@bils.com', '', 1, '', '$2y$10$ta1BmsLnz8H4tUqFJHI8puHxhCldn9DSwVfQjc3g59v9YSxM7.Trq', NULL, 0, 1, NULL, '2020-01-24 17:30:45', '2020-01-24 06:51:31', '2020-02-08 05:58:40'),
...
-- Dumping data for table bils_db.user_groups: ~3 rows (approximately)
...
INSERT INTO `user_groups` (`id`, `group_name`, `type`, `status`, `created_at`, `updated_at`) VALUES
	...
	(27, 'Web View', 2, 1, '2020-02-08 13:02:57', '2020-02-08 13:02:57');
...
-- Dumping data for table bils_db.user_group_members: ~1 rows (approximately)
...
INSERT INTO `user_group_members` (`id`, `emp_id`, `group_id`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 26, 1, '2020-02-06 11:33:26', '2020-02-06 11:33:26');
...
-- Dumping data for table bils_db.user_group_permissions: ~8 rows (approximately)
...
INSERT INTO `user_group_permissions` (`id`, `group_id`, `action_id`, `status`, `created_at`, `updated_at`) VALUES
	...
	(12, 25, 7, 0, '2020-02-07 10:23:56', '2020-02-07 10:23:56'),
