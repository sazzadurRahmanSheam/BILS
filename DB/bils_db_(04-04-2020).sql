...
-- Dumping data for table bils_new_db.menus: ~33 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='m';
...
INSERT INTO `users` (`id`, `name`, `nid_no`, `contact_no`, `email`, `address`, `user_type`, `user_profile_image`, `password`, `remember_token`, `login_status`, `status`, `remarks`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', '12345', '01980340482', 'momit@bils.com', 'Mohammadpur,dhaka', 1, '1585081916.jpg', '$2y$10$ta1BmsLnz8H4tUqFJHI8puHxhCldn9DSwVfQjc3g59v9YSxM7.Trq', NULL, 0, 1, 'He is good enough', '2020-01-24 17:30:45', '2020-01-24 06:51:31', '2020-04-04 05:49:52'),
...
-- Dumping data for table bils_new_db.user_group_permissions: ~304 rows (approximately)
...
-- Dumping data for table bils_new_db.web_actions: ~75 rows (approximately)
