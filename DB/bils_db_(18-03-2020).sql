...
INSERT INTO `course_masters` (`id`, `course_code`, `course_title`, `duration`, `appx_start_time`, `appx_end_time`, `act_start_time`, `act_end_time`, `course_type`, `course_teacher`, `course_responsible_person`, `details`, `course_status`, `payment_fee`, `payment_method`, `discount_message`, `attachment`, `pub_status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(4, 'course-1', 'Labour Study', 10, '2020-03-03', '2020-04-27', NULL, NULL, 3, 'Sazzadur Raman', 'admin', 'this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study. this is about labor study.', NULL, 500, 'Bkash', 'No discount available', NULL, 1, 'Momit', 'Momit', '2020-03-05 06:06:36', '2020-03-18 19:11:27'),
	(5, 'course-2', 'Web Design', NULL, '2020-02-16', NULL, NULL, NULL, NULL, NULL, 'admin', 'this is about web design.', 1, NULL, NULL, NULL, NULL, 1, 'Momit', 'Momit', '2020-03-05 07:41:23', '2020-03-18 19:11:32');
...
-- Dumping data for table bils_new_db.course_perticipants: ~25 rows (approximately)
...
INSERT INTO `course_perticipants` (`id`, `course_id`, `perticipant_id`, `is_interested`, `is_selected`, `status`, `created_at`, `updated_at`) VALUES
	...
	(20, 4, 6, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(21, 4, 7, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(22, 4, 10, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(23, 4, 11, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(24, 4, 9, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(25, 4, 12, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(26, 4, 13, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(27, 4, 5, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(28, 4, 8, 0, NULL, NULL, '2020-03-18 08:59:54', '2020-03-18 08:59:54');
...
-- Dumping data for table bils_new_db.menus: ~29 rows (approximately)
...
INSERT INTO `message_attachments` (`id`, `message_master_id`, `attachment_type`, `admin_atachment`, `app_user_attachment`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, '', '164838449515845342981555317138760.jpg', '2020-03-18 12:24:58', '2020-03-18 12:24:58'),
	(2, 3, 1, '', '10477442041584534540b.jpg', '2020-03-18 12:29:00', '2020-03-18 12:29:00'),
	(3, 4, 4, '', '762068531584534900bils bug.txt', '2020-03-18 12:35:00', '2020-03-18 12:35:00'),
	(4, 5, 4, '12364490971584534932bils bug.txt', '', '2020-03-18 12:35:32', '2020-03-18 12:35:32');
...
-- Dumping data for table bils_new_db.message_masters: ~0 rows (approximately)
...
INSERT INTO `message_masters` (`id`, `message_id`, `is_attachment`, `is_attachment_app_user`, `admin_id`, `admin_message`, `app_user_id`, `app_user_message`, `is_seen`, `message_category`, `message_date_time`, `status`, `created_at`, `updated_at`) VALUES
	(1, NULL, 0, 1, NULL, NULL, 5, NULL, 0, NULL, '2020-03-18 18:24:58', NULL, '2020-03-18 12:24:58', '2020-03-18 12:24:58'),
	(2, NULL, 0, 0, 1, 'hi', 5, NULL, 0, NULL, '2020-03-18 18:28:34', NULL, '2020-03-18 12:28:34', '2020-03-18 12:28:34'),
	(3, NULL, 0, 1, NULL, NULL, 5, 'hi', 0, NULL, '2020-03-18 18:29:00', NULL, '2020-03-18 12:29:00', '2020-03-18 12:29:00'),
	(4, NULL, 0, 1, NULL, NULL, 5, NULL, 0, NULL, '2020-03-18 18:35:00', NULL, '2020-03-18 12:35:00', '2020-03-18 12:35:00'),
	(5, NULL, 1, 0, 1, NULL, 5, NULL, 0, NULL, '2020-03-18 18:35:32', NULL, '2020-03-18 12:35:32', '2020-03-18 12:35:32');
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='m';

-- Dumping data for table bils_new_db.notifications: ~25 rows (approximately)
...
INSERT INTO `notifications` (`id`, `from_id`, `from_user_type`, `to_id`, `to_user_type`, `date_time`, `notification_title`, `message`, `view_url`, `status`, `created_at`, `updated_at`) VALUES
	...
	(28, 1, 'Admin', 6, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(29, 1, 'Admin', 7, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(30, 1, 'Admin', 10, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(31, 1, 'Admin', 11, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(32, 1, 'Admin', 9, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(33, 1, 'Admin', 12, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(34, 1, 'Admin', 13, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(35, 1, 'Admin', 5, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54'),
	(36, 1, 'Admin', 8, 'App User', '2020-03-18 14:59:54', 'BILS Initiate Labour Study Course', NULL, 'course/4', 0, '2020-03-18 08:59:54', '2020-03-18 08:59:54');
